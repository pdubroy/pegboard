...
export function ES5(ns) {
  ...
  return new ns.Matcher({
    ...
    program: seq(
      lookahead(rep(app("directive"))),
      rep(app("sourceElement")),
      app("spaces"),
    ),
    ...
    multiLineComment: seq(
      _("/*"),
      rep(seq(not(_("*/")), app("sourceCharacter"))),
      _("*/"),
    ),
    ...
    booleanLiteral: seq(
      choice(_("true"), _("false")),
      not(app("identifierPart")),
    ),
    ...
    decimalLiteral: choice(
      seq(
        app("decimalIntegerLiteral"),
        _("."),
        rep(app("decimalDigit")),
        app("exponentPart"),
      ),
      seq(
        _("."),
    ...
    decimalIntegerLiteral: choice(
      seq(app("nonZeroDigit"), rep(app("decimalDigit"))),
      _("0"),
    ),
    decimalDigit: range("0", "9"),
    nonZeroDigit: range("1", "9"),
    exponentPart: choice(
      seq(app("exponentIndicator"), app("signedInteger")),
      seq(),
    ),
    ...
    octalIntegerLiteral: seq(
      _("0"),
      seq(app("octalDigit"), rep(app("octalDigit"))),
    ),
    ...
    doubleStringCharacter: choice(
      seq(
        not(choice(_('"'), _("\\"), app("lineTerminator"))),
        app("sourceCharacter"),
      ),
    ...
    characterEscapeSequence: choice(
      app("singleEscapeCharacter"),
      app("nonEscapeCharacter"),
    ),
    ...
    regularExpressionFirstChar: choice(
      seq(
        not(choice(_("*"), _("\\"), _("/"), _("["))),
        app("regularExpressionNonTerminator"),
      ),
    ...
    regularExpressionBackslashSequence: seq(
      _("\\"),
      app("regularExpressionNonTerminator"),
    ),
    regularExpressionNonTerminator: seq(
      not(app("lineTerminator")),
      app("sourceCharacter"),
    ),
    regularExpressionClass: seq(
      _("["),
      rep(app("regularExpressionClassChar")),
      _("]"),
    ),
    ...
    multiLineCommentNoNL: seq(
      ...
      rep(
        seq(
          not(choice(_("*/"), app("lineTerminator"))),
          app("sourceCharacter"),
        ),
      ),
      _("*/"),
    ...
    spacesNoNL: rep(
      choice(
        app("whitespace"),
        app("singleLineComment"),
        app("multiLineCommentNoNL"),
      ),
    ),
    sc: choice(
    ...
    memberExpression: seq(
      app("memberExpressionHead"),
      rep(app("memberExpressionTail")),
    ),
    ...
    postfixExpression: choice(
      seq(
        ...
        lexIgnored(seq(app("spacesNoNL"), _("++"))),
      ),
      seq(
        app("leftHandSideExpression"),
        lexIgnored(seq(app("spacesNoNL"), _("--"))),
    ...
    continueStatement: seq(
      ...
      lexIgnored(
        seq(
          choice(seq(app("spacesNoNL"), app("identifier")), seq()),
          app("sc"),
        ),
      ),
    ),
    ...
    returnStatement: seq(
      ...
      choice(
        seq(
          lexIgnored(seq(app("spacesNoNL"), not(app("space")))),
          app("expression"),
        ),
        seq(),
      ),
    ...
    debuggerStatement: seq(
      app("spaces"),
      lexIgnored(seq(app("debugger"), app("sc"))),
    ),
    ...
    formalParameterList: choice(
      seq(
        app("formalParameter"),
        rep(seq(app("spaces"), _(","), app("formalParameter"))),
      ),
      seq(),
    ),
